...
**參考範例（僅供格式參考）**：
「個案：洪范鳳英 04019515（女）85 歲 1940/01/18, N200935271；History：Severe Aortic stenosis、Hypertension、Hyperlipidemia，在門診追蹤治療；近期常發生暈眩及暈倒情形，此次於 114/11/26 因 Syncope 至急診求治。於 114/11/27 心臟超音波檢查：Very Severe AS (AVA:0.67cm², Vmax:5.61m/s, Peak PG:126mmHg, Mean PG:76mmHg)，於 114/11/28 安排心導管檢查，冠狀動脈無明顯狹窄。經二位心臟外科專科醫師（XXX、XXX）評估，STS score 13.4%，傳統開心手術風險過高；病患平時日常生活尚可自理，臨床上判定病患至少有一年以上之存活機率。經醫病共享決策與家屬討論後，決定申請經導管主動脈瓣膜置換手術（TAVI）。由於主動脈瓣膜重度狹窄（Critical AS）隨時都有猝死的可能，需儘速施行 TAVI 手術以改善症狀，惠請貴局同意。」
...
5. 日期已轉為民國年，請直接使用
6. **病史（History）用通順的中文表達即可**，不需要刻意使用英文醫學術語
7. 檢查結果的關鍵術語保持英文（如 AVA、Vmax、Peak PG、Mean PG 等）
